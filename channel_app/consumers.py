...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    async def receive(self, text_data):
        ...
        author_user = await database_sync_to_async(User.objects.get)(username=author)
        print(author_user)
        message = await database_sync_to_async(Chat.objects.create)(
            user=author_user,
            message=message['mes']
        )
        message = await database_sync_to_async(Chat.last_10_messages())
